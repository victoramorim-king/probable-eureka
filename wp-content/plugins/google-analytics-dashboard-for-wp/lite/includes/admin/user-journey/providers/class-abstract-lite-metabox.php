...
abstract class ExactMetrics_User_Journey_Lite_Metabox {
	 ...
	 * @var string
	 */
	public $assets_url = EXACTMETRICS_PLUGIN_URL . 'lite/includes/admin/user-journey/assets/';
	...
	public function metabox_html() {
		...
		$learn_more   = exactmetrics_get_upgrade_link( $utm_provider, 'lite-user-journey', 'https://exactmetrics.com' );
		$upgrade_link = exactmetrics_get_upgrade_link( $utm_provider, 'lite-user-journey', 'https://exactmetrics.com/lite' );
		?>
		<!-- User Journey metabox -->
		<?php $this->metabox_title(); ?>
		<div id="exactmetrics-user-journey-lite-metabox-container">
			<div class="exactmetrics-lite-uj-backdrop-pic"
				 style="background-image: url( '<?php echo esc_url( $this->assets_url ); ?>img/user-journey-backdrop.png' )"></div>
			<div id="exactmetrics-lite-entry-user-journey" class="postbox">
				<div class="exactmetrics-lite-uj-container desktop">
					<div class="exactmetrics-lite-uj-modal-head">
						<h3><?php esc_html_e( 'Unlock User Journey', 'exactmetrics' ); ?></h3>
					</div>
					<div class="exactmetrics-lite-uj-modal-content">
						<div class="exactmetrics-lite-modal-left">
							<h4><?php esc_html_e( 'With ExactMetrics Pro, See Each Step Your Visitor Took Before Purchasing From Your Website.', 'exactmetrics' ); ?></h4>
							<p>
								<?php
								// Translators: strong tag to make text bold, link to website to learn more
								echo sprintf(
									esc_html__('%1$sPlus%2$s, upgrading to pro will unlock %3$sall%4$s of advanced reports, tracking, and integrations. %5$sLearn more about Pro%6$s', 'exactmetrics'),
									'<strong>',
									'</strong>',
									'<strong>',
									'</strong>',
									'<a target="_blank" href="' . esc_url($learn_more) . '" title="'.  esc_attr__('Upgrade', 'exactmetrics') .'">',
									'</a>'
								); ?>
							</p>
							<a target="_blank" href="<?php echo esc_url( $upgrade_link ); ?>" title=""
							   class="exactmetrics-uj-button exactmetrics-button">
								<?php esc_html_e( 'Upgrade and Unlock', 'exactmetrics' ); ?>
						...
						<div class="exactmetrics-lite-modal-right">
							<img src="<?php echo esc_url( $image ); ?>" alt="Frame"/>
						</div>
					</div>
				</div>
				<div class="exactmetrics-lite-uj-container mobile">
					<div class="exactmetrics-lite-uj-modal-content">
						<div class="exactmetrics-lite-modal-left">
							<h4><?php esc_html_e( 'User Journey', 'exactmetrics' ); ?></h4>
							<p><?php esc_html_e( 'See each step your visitor took before purchasing from your site', 'exactmetrics' ); ?></p>
						</div>
					</div>
				</div>
			</div>
			<div class="exactmetrics-lite-uj-upgrade">
				<p>
					...
					<?php esc_html_e( 'This is a PRO feature.', 'exactmetrics' ); ?>
					<a target="_blank" href="<?php echo esc_url( $upgrade_link ); ?>"
					   title=""><?php esc_html_e( 'Upgrade', 'exactmetrics' ); ?></a>
				</p>
			</div>
		</div>
		<?php
